...
class Magazento_Megamenu_Block_Navigation extends Mage_Core_Block_Template {
    ...
    protected function _prepareLayout()
    {
        ...
        $skin='menu.css';
        $this->getLayout()->getBlock('head')->addCss('magazento/megamenu/'.$skin);
...
//        $url=$this->getCategoryUrl($category);
        ...
        $html = '<li class="over drop menu_'.$item['align_category'].' '.$class.'">';
    ...
    public function drawColumns($children,$item) {
		...
		$processor = $helper->getPageTemplateProcessor();
            ...
            $html .= '</div></div>';
        //////////Fix code/////////
        $html .= '<div class="col_1"><div class="menu-left">'.$this->getLayout()->createBlock('cms/block')->setBlockId('menu_left')->toHtml().'</div></div>';
        /////////End fix///////////
        ...
        //////////Fix code/////////
        $html .= '<div class="col_1"><div class="menu-right">'.$this->getLayout()->createBlock('cms/block')->setBlockId('menu_right')->toHtml().'</div></div>';
        /////////End fix///////////
            $html .= '<div class="col_'.$col.'"><div class="content_bottom">';
			$html .= $processor->filter($item['content_bottom']);   
            $html .= '</div></div>';
